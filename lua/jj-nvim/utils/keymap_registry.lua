...
M.initialize = function(config)
  ...
  M.register_batch("actions", {
    ...
    ["A"] = "Abandon commits (multi-select mode)",
    [log_actions.squash or legacy_keymaps.squash or "x"] = "Quick squash (cursor commit into parent)",
    [log_actions.squash_menu or "X"] = "Squash menu (select target)",
